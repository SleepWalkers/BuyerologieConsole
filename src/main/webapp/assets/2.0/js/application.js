...
$(function () {
    ...
    $.each ($('ul.acc-menu a'), function() {
        if( this.href == window.location ) {
            ...
            if(localStorage!= null){
            	localStorage.menu_target_href = $(this).attr("href");
            }
            return false;
        }
    });
    ...
    var parent = null;
    if(localStorage != null &&localStorage.menu_target_href != null){
    	parent = $("ul.acc-menu a[href='" + localStorage.menu_target_href + "']").closest('li');
    }else{
    	parent = $(targetAnchor).closest('li');
    }
